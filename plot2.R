plot2 <- function()
{
        ...
        #vector of y values is the required data from the powcon data frame
        #type of graph "l" is a line graph
        #no main title, yaxis title is set, no x axis title , x axis removed.
        png(file = "plot2.png", bg = "transparent")
        plot(x = seq(1:nrow(powcon)), y=powcon$Global_active_power,type="l",main = "", ylab = "Global active power (kilowatts)", xlab="", xaxt="n")
